...
const SuccessBooking = ({ route }) => {
    ...
    return (
        <SafeAreaView className="relative h-full bg-white">
            ...
            <Text className="text-center mt-4 font-semibold">Booking confirmed!</Text>
            <Text className="text-center mt-3 px-5">Thank you for booking with us we will get back to you soon</Text>
