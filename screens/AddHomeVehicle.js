...
import { View, Text, SafeAreaView, Image, TouchableOpacity, TouchableWithoutFeedback, Keyboard } from 'react-native'
    ...
    return (
        <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
            <SafeAreaView className="px-4 mt-5 h-full w-full bg-white">
                ...
                <View className="px-4">
                    <Text className="mt-5 text-[17px] mb-1">Registration Plate</Text>
                    <TextInput
                        mode="outlined"
                    ...
                    <CheckBox
                        ...
                        isChecked={licensed}
                    />
                    <Text className="mt-5 text-[17px] mb-1">Model</Text>
                    <TextInput
                        mode="outlined"
                        className="bg-slate-100"
                        text="Model"
                    ...
                    />
                    <Text className="mt-5 text-[17px] mb-1">Make</Text>
                    <TextInput
                        mode="outlined"
                        className="bg-slate-100"
                        text="Make"
                    ...
                    />
                    <Text className="mt-5 text-[17px] mb-1">Colour</Text>
                    <TextInput
                        mode="outlined"
                        className="bg-slate-100"
                        text="Colour"
                ...
                <View>
                    <Text className="px-4 mt-8 text-[#acacac]">Please check here to agree that we will store and
                        process data about your vehicle in order to provide
                        you our services
                    </Text>
                    <CheckBox
                ...
                <View className="px-4 mt-10">
                    {data ?
                        <Button className="bg-[#00BCD4]" mode="contained" onPress={handleUpdate}>
                            Update
                        </Button> : <Button disabled={!agree} className="bg-[#00BCD4]" mode="contained" onPress={handleSubmit}>
                            Submit
                        </Button>
                    }
