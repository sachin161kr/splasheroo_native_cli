        ...
        <SafeAreaView>
            <View className="px-4">
                ...
                <View className="mt-5 px-5">
                    <Text className="text-center">
                        We sent you a verification link via
                        email. Please click it to verify your
                        email address. If you don’t see it,
                        please check your spam folder.
                    </Text>
                </View>
                <View className="mt-10 px-4">
                    <Button className="bg-[#00BCD4]" mode="contained" onPress={emailVerification}>
