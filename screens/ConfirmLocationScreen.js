      ...
      <ScrollView>
        <View className="px-4">
          <View className="flex-row items-center">
            ...
            <Text className="text-2xl ml-20 text-center">Confirm Location</Text>
          </View>
          ...
          <View>
            <View className="px-4 mt-5">
              ...
              <View className="mt-3 flex-row justify-between items-center">
                ...
                <View>
                  <TouchableOpacity className="relative bottom-0 bg-[#00BCD4] border-none py-4 px-5 h-100 w-100 mt-1 ml-1" mode="contained" onPress={handleSearch}>
                    <Text>Search</Text>
                  </TouchableOpacity>
                </View>
              </View>
          ...
          <View>
            <Button
              className={!addPostCode || !landMark ? "bg-[#E2EDF6]" : "bg-[#00BCD4]"}
              mode="contained"
