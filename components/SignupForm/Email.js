    ...
    return (
        <View>
            <View className="px-4 mt-5">
                <Text className="mt-5 text-[17px] mb-5">Email Address</Text>
                <TextInput
                    type="email"
                    label="Enter Email"
                ...
                />
                <Text className={!error.emailError ? "text-center mt-3 text-[#009919]" : "text-center mt-3"}>Email must be valid</Text>
            </View>
        </View>
    )
}
