    ...
    return (
        <View>
            <View className="px-4 mt-5">
                <Text className="mt-5 text-[17px] mb-5">Enter Phone Number</Text>
                <TextInput
                    type="number"
                ...
                />
                <Text className={!error.phoneError ? "text-center mt-3 text-[#009919]" : "text-center mt-3"}>Phone number must have 10 digits</Text>
            </View>
        </View>
    )
}
