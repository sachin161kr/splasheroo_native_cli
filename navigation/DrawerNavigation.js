...
export default function DrawerNavigation() {
  ...
  return (
          ...
          <>
            ...
            <DrawerContentScrollView>
              ...
              {/* <DrawerItem
                ...
                pressColor="#E2EDF6"
                style={{
                  backgroundColor: map["vehicle"] == true ? "#E2EDF6" : "#FFF",
                  borderRadius: 30,
                  padding: 8,
                }}
              /> */}
                ...
                pressColor="#E2EDF6"
                style={{
                  backgroundColor: map["GetVehicle"] == true ? "#E2EDF6" : "#FFF",
                  borderRadius: 30,
                  padding: 8,
                }}
              />
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                Linking.canOpenURL("https://splasheroo.co.uk/terms-and-conditions.html").then(
                  (supported) => {
                    if (supported) {
                      Linking.openURL("https://splasheroo.co.uk/terms-and-conditions.html");
                    } else {
    ...
    >
      ...
      <Drawer.Screen name="ChooseVehicleScreen" component={MainStackNavigator} />
